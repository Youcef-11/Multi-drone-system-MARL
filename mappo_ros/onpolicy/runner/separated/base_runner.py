...
class Runner(object):
    def __init__(self, config):
        ...
        self.n_rollout_threads = self.all_args.n_rollout_threads # number of parallel envs for training rollout. by default 32
        self.n_eval_rollout_threads = self.all_args.n_eval_rollout_threads
        self.use_linear_lr_decay = self.all_args.use_linear_lr_decay
        self.hidden_size = self.all_args.hidden_size # default = 64
        self.use_wandb = self.all_args.use_wandb
        self.use_render = self.all_args.use_render
        self.recurrent_N = self.all_args.recurrent_N # The number of recurrent layers ( default 1)
