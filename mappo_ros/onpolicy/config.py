...
def get_config():
    ...
    parser.add_argument("--n_rollout_threads", type=int, default=1, # default=32
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='drone', help="specify the name of environment")
