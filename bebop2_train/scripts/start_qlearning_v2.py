...
if __name__ == '__main__':
    ...
    rospy.init_node('parrotdrone_goto_qlearn', anonymous=True, log_level=rospy.WARN)

    # Init OpenAI_ROS ENV
    task_and_robot_environment_name = rospy.get_param( '/drone/task_and_robot_environment_name')
